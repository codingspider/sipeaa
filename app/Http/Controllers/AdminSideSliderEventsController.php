<?php namespace App\Http\Controllers;
	...
	class AdminSideSliderEventsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Venue","name"=>"venue"];
			...
			$this->form[] = ['label'=>'Venue','name'=>'venue','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Venue","name"=>"venue","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
