                        ...
                        <section id="tabs">
                            <div class="container">
                              ...
                              <div class="row">
                                <div class="col-xs-10">
                                  <nav>
                                    <div style="padding-left: 80px;" class="nav nav-tabs" id="nav-tab" role="tablist">
                                  ...
                                  <div style="padding-left: 80px;" class="tab-content " id="nav-tabContent">
                                          ...
                                          <div class="col-md-12">
                                              <table class="table">
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <th> <button class="btn btn-primary" OnClick="DoAction({{ $item->id }});" > Message </button> </th>
